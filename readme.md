...
![GitHub Repo stars](https://img.shields.io/github/stars/lagzian/new-configs-collector?label=Stars&color=red)
![GitHub forks](https://img.shields.io/github/forks/lagzian/new-configs-collector?label=Forks&color=blue)
...
- **REALITY**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/protocols/reality
```
- **VLESS**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/protocols/vless
```
- **VMESS**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/protocols/vmess
```
- **TROJAN**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/protocols/trojan
```
- **SHADOWSOCKS**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/protocols/shadowsocks
```
Configuration subscription links based on network type
- **GRPC**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/networks/grpc
```
- **HTTP**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/networks/http
```
- **WS**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/networks/ws
```
- **TCP**
```
https://raw.githubusercontent.com/lagzian/new-configs-collector/main/networks/tcp
```
